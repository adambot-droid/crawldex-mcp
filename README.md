...
[![CI](https://github.com/crawldex/crawldex-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/crawldex/crawldex-mcp/actions/workflows/ci.yml) [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

21% of measured CrawlDex site-task rows need a person nearby before completion (n=8,401, source: https://crawldex.com/board.json). Run CrawlDex preflight as a read-only MCP server before an agent attempts a public website task.

```bash
CRAWLDEX_API_ORIGIN=https://crawldex.com CRAWLDEX_CHANNEL=readme-github npx -y crawldex-mcp
```
